...
public class WikimediaChangeConsumer {
    private static final Logger log = LoggerFactory.getLogger(WikimediaChangeConsumer.class.getSimpleName());
    ...
    public static void main(String[] args) {
        ...
        log.info("consumer porperties setting");
        ...
        while (true) {
            ...
            for (ConsumerRecord<String, String> record : records) {
                System.out.println("Value_length: " + record.value().length() +
